...
def vancouver_grid(head, divisions_longs, divisions_lats):
    """
    ...
    divisions_lats (int): Number of divisions along the latitude (default is 15).
    ...
    coord_boxes = split_coordinate(four_coords, divisions_longs, divisions_lats, if_big_box=0)
